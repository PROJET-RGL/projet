...
{
    int volume = 10, touche, presserQ = FALSE, presserD = FALSE, presserS = FALSE, presserZ = FALSE;

    SDL_bool plein_ecran = SDL_FALSE, ingame = SDL_FALSE;
    ...
    {
        exit_menu = load_menu(renderer, fen, &volume, &plein_ecran, ingame);
